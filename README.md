...
# Installation 
(https://docs.github.com/en/pages/setting-up-a-github-pages-site-with-jekyll/creating-a-github-pages-site-with-jekyll)[Install Ruby & Bundler]
(https://jekyllrb.com/docs/installation/ubuntu/)[Add Jekyll]
To run: **bundle exec jekyll serve **
if **bundler: failed to load command: jekyll**
**add bundle add webrick**
and run again
Optionally remove and add Gemfile.lock